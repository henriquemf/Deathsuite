...
{
	[SerializeField] private float m_JumpForce = 1300f;							// Amount of force added when the player jumps.
	...
	public void Move(float move, bool crouch, bool jump)
	{
		...
		if (m_Grounded || m_AirControl)
		{
			...
			animator.SetBool("isJumping", !m_Grounded && m_Rigidbody2D.velocity.y > 5.1f);
			animator.SetBool("isFalling", !m_Grounded && m_Rigidbody2D.velocity.y < -3.1f);
